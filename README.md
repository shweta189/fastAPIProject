...
The project's goal was for me to get used to and get hands-on experience with the FastAPI framework.

The project is a **Machine Learning - Powered API** built using FastAPI to predict the selling price of a used car based on its characteristics.
